  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="text-align: center">
      ...
      <form action="ricerca.php" method="POST" class="d-flex">
        ...
        <h3>Modifica il documento digitale</h3>
        <div class="container">
            <form action="modificaDigitale.php" method="POST">
            <br>
            <input type="text" name="nome" placeholder="nome"><br />
            <br>
            <input type="text" name="URL" placeholder="URL"><br />
            <br>
            <input type="text" name="applicazione_riproduzione" placeholder="applicazione di riproduzione"><br />
            <br>
            <input type="text" name="apparato_ausiliiario" placeholder="apparato ausiliiario"><br />
            <br>
            <input type="submit">
        </form>
        </div>    
