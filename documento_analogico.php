  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="text-align: center">
      ...
      <form action="ricerca.php" method="POST" class="d-flex">
        ...
        $supporto = $documento_digitale["supporto"];
        $luogo_custodia = $documento_digitale["lugod_custodia"];
        ...
        echo '</tr>';
        echo '<tr>';
        echo "<td>Luogo di custodia</td>";
        echo "<td>$luogo_custodia</td>";
        echo '</tr>';
        echo '<tr>';
        echo "<td>Descrizione</td>";
        echo "<td>$caratteristiche</td>";
        echo '</tr>';
        echo '</td>';
